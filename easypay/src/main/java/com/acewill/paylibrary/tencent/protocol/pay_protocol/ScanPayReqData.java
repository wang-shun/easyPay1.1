...
public class ScanPayReqData {
	...
	public ScanPayReqData(String authCode, String body, String attach,
		...
		if (!TextUtils.isEmpty(sub_mch_id)) {
			setSub_mch_id(sub_mch_id);
		}
		setReqData(authCode, body, attach, outTradeNo, totalFee, deviceInfo, spBillCreateIP, timeStart, timeExpire, goodsTag);
	}
	...
	private void setReqData(String authCode, String body, String attach,
			String outTradeNo, int totalFee, String deviceInfo,
			String spBillCreateIP, String timeStart, String timeExpire,
			String goodsTag){
