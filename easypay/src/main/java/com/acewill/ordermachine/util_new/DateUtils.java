...
public class DateUtils {
	...
	public static final String[] zodiacArr = {"猴", "鸡", "狗", "猪", "鼠", "牛", "虎", "兔", "龙", "蛇", "马",
			"羊"};

	public static final String[] constellationArr = {"水瓶座", "双鱼座", "白羊座", "金牛座", "双子座", "巨蟹座",
	 ...
	 * @return 默认格式 Wed May 31 14:47:18 CST 2017
	 */
	public static Date getBeginTheDayBeforeYesterday() {
		Calendar cal = new GregorianCalendar();
		cal.setTime(getDayBegin());
	 ...
	 * 获取前天的结束时间
	 *
	 * @return 默认格式 Wed May 31 14:4nd7:18 CST 2017
	 */
	public static Date getEndTheDayBeforeYesterday() {
		Calendar cal = new GregorianCalendar();
		cal.setTime(getDayEnd());
		cal.add(Calendar.DAY_OF_MONTH, -2);
		return cal.getTime();
	...
	public static Date getEndDayOfMonth() {
		Calendar calendar = Calendar.getInstance();
		calendar.set(getNowYear(), getNowMonth() - 1, 1);
		int day = calendar.getActualMaximum(Calendar.THURSDAY);
